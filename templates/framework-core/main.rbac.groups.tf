...
locals {
  ad_group_rbac = merge(
    var.ad_read_group_id != null && var.ad_read_group_id != "" ? {
      ...
      read_appins_reader = {
        principal_id         = var.ad_read_group_id
        scope_id             = module.application_insights.application_insights_id
      ...
      read_key_vault_reader = {
        principal_id         = var.ad_read_group_id
        scope_id             = module.key_vault.id
        role_definition_name = "Reader"
        principal_type       = "Group"
      }
      read_storage_reader = {
      ...
      read_ai_hub_reader = {
        principal_id         = var.ad_read_group_id
        scope_id             = module.ai_hub.ai_hub_id
        role_definition_name = "Reader"
        principal_type       = "Group"
      }
    ...
    var.ad_full_group_id != null && var.ad_full_group_id != "" ? {
      ...
      full_ai_search_reader = {
        principal_id         = var.ad_full_group_id
        scope_id             = module.ai_search_service.search_service_id
        role_definition_name = "Reader"
        principal_type       = "Group"
      }
      full_ai_search_service_contrib = {
        principal_id         = var.ad_full_group_id
        scope_id             = module.ai_search_service.search_service_id
