...
## 1. Module
Create an Azure Key Vault with secure defaults (RBAC auth, private network access by default), optional Private Endpoint, and customizable retention and access policies.
