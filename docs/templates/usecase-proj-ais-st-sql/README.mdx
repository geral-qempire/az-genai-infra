...
## 4. Outputs
Resource IDs and names for AI Services, Storage, SQL Server/Database, Services→Project connection, and role assignment maps. See the template `output.tf` for details.
