...
## 1. Module
Create an Azure AI Hub Project (Azure AI Foundry Project) under an existing AI Hub.
...
module "ai_project" {
  ...
  environment          = "dev"
  service_prefix       = "acme"
  resource_group_name  = "rg-ignored-for-project" # Project derives RG from Hub; kept for consistency
  location             = "westeurope"
