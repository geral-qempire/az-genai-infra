...
## 1. Module
Create an Azure Monitor metric alert for Azure OpenAI availability rate split by model deployment:
...
```hcl
module "ai_azureopenai_availabilityrate_alert_all" {
  source = "../ai-services-avail"
