...
locals {
  private_endpoint_name           = "pep-ais-${local.region_abbreviation}-${var.service_prefix}-${var.environment}"
  private_endpoint_nic_name       = "nic-pep-ais-${local.region_abbreviation}-${var.service_prefix}-${var.environment}"
